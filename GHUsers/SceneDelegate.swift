...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createTabbar() -> UITabBarController {
        ...
        let searchNavVC = createSearchNavigationController()
        let favoritesListNavVC = createFavoriteListNavigationController()
        tabBar.viewControllers = [searchNavVC, favoritesListNavVC]
